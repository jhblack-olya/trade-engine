...
type Order struct {
	...
	Size          decimal.Decimal `gorm:"column:size" sql:"type:decimal(32,16);"`
	Funds         decimal.Decimal `gorm:"column:funds" sql:"type:decimal(32,16);"`
	FilledSize    decimal.Decimal `gorm:"column:filled_size" sql:"type:decimal(32,16);"`
	ExecutedValue decimal.Decimal `gorm:"column:executed_value" sql:"type:decimal(32,16);"`
	Price         decimal.Decimal `sql:"type:decimal(32,16);"`
